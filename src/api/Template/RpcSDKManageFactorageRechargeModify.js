...
export const RpcSDKManageFactorageRechargeModifyMethod = '/sdkmanage/factorage/recharge/modify';

export const RpcSDKManageFactorageRechargeModifyRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageFactorageRechargeModify (
  merchantNo,
  ratioMemberOrigin,
  ratioMemberNormal,
  ratioMemberMiniPay) {
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageFactorageRechargeModifyMethod, params);
  } else {
    return Rpc.get(RpcSDKManageFactorageRechargeModifyMethod, params);
  }
}
