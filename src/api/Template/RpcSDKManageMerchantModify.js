...
export const RpcSDKManageMerchantModifyMethod = '/sdkmanage/merchant/modify';

export const RpcSDKManageMerchantModifyRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageMerchantModify (
  merchantNO,
  merchantName = null,
  alias = null,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageMerchantModifyMethod, params);
  } else {
    return Rpc.get(RpcSDKManageMerchantModifyMethod, params);
  }
}
