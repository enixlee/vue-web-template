...
export const RpcSDKManageActivityActiveCardQueryMethod = '/sdkmanage/activity/active_card/query';

export const RpcSDKManageActivityActiveCardQueryRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageActivityActiveCardQuery (
  ID = null,
  merchantNo = null,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageActivityActiveCardQueryMethod, params);
  } else {
    return Rpc.get(RpcSDKManageActivityActiveCardQueryMethod, params);
  }
}
