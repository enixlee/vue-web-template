...
export const RpcSDKManageMerchantPaymentIDModifyMethod = '/sdkmanage/merchant/payment_id/modify';

export const RpcSDKManageMerchantPaymentIDModifyRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageMerchantPaymentIDModify (
  merchantNo,
  allPeoplePayId = null,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageMerchantPaymentIDModifyMethod, params);
  } else {
    return Rpc.get(RpcSDKManageMerchantPaymentIDModifyMethod, params);
  }
}
