...
export const RpcSDKManageFactorageConsumptionQueryMethod = '/sdkmanage/factorage/consumption/query';

export const RpcSDKManageFactorageConsumptionQueryRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageFactorageConsumptionQuery (
  merchantNo = null,
  status = null,
  sortBy = 0,
  desc = 0,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageFactorageConsumptionQueryMethod, params);
  } else {
    return Rpc.get(RpcSDKManageFactorageConsumptionQueryMethod, params);
  }
}
