...
export const RpcSDKManageDiscountMerchantQueryMethod = '/sdkmanage/discount/merchant/query';

export const RpcSDKManageDiscountMerchantQueryRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageDiscountMerchantQuery (
  ID = null,
  merchantNo = null,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageDiscountMerchantQueryMethod, params);
  } else {
    return Rpc.get(RpcSDKManageDiscountMerchantQueryMethod, params);
  }
}
