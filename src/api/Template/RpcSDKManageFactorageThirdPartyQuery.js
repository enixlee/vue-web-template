...
export const RpcSDKManageFactorageThirdPartyQueryMethod = '/sdkmanage/factorage/third_party/query';

export const RpcSDKManageFactorageThirdPartyQueryRpcType = 'system';
 ...
 * @constructor
 */
export function RpcSDKManageFactorageThirdPartyQuery (
  merchantNo = null,
  status = null,
  pageIndex = 1,
  pageCount = 50,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageFactorageThirdPartyQueryMethod, params);
  } else {
    return Rpc.get(RpcSDKManageFactorageThirdPartyQueryMethod, params);
  }
}
