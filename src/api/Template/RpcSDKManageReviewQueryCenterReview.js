...
export const RpcSDKManageReviewQueryCenterReviewMethod = '/sdkmanage/review/query_center_review';

export const RpcSDKManageReviewQueryCenterReviewRpcType = 'system';

/**
 *
 * @param reviewId |null bigint 审核编号
 * @param reviewType |null centerReviewTypeJsonArray 审核类型，数组格式
 ...
 * @constructor
 */
export function RpcSDKManageReviewQueryCenterReview (
  reviewId = null,
  reviewType = null,
  reviewRecordId = null,
  result = null,
  ...
  if (debug.isProduction()) {
    return Rpc.post(RpcSDKManageReviewQueryCenterReviewMethod, params);
  } else {
    return Rpc.get(RpcSDKManageReviewQueryCenterReviewMethod, params);
  }
}
