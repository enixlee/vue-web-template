...
export const RpcSDKManageReviewReviewMethod = '/sdk_manage/v2/review/review';
...
export function RpcSDKManageReviewReview (
  ...
  if (debug.isProduction()) {
    ...
    if (Vue.prototype.getPlugin('lodash').isObject(mockEngine)) {
      let data = mockEngine[RpcSDKManageReviewReviewMethod];
          ...
          let rpcResult = Vue.prototype.getPlugin('RpcCommandResultMaker')(
            {
              ...
              config: {},
              data: {
                command_name: RpcSDKManageReviewReviewMethod,
                description: 'succ',
                code: 'succ',
                data: data,
                succ: true
